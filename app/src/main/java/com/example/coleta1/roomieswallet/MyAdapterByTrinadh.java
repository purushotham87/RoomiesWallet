...
public class MyAdapterByTrinadh extends RecyclerView.Adapter<MyAdapterByTrinadh.MyViewHolder> {
    ...
    public MyAdapterByTrinadh(ArrayList<ByPersonStatus> people) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent,
        ...
        view.setOnClickListener(ViewStatusTrinadh.myOnClickListener);
