...
public class MyAdapterByAnji extends RecyclerView.Adapter<MyAdapterByAnji.MyViewHolder> {
    ...
    public MyAdapterByAnji(ArrayList<ByPersonStatus> people) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent,
        ...
        view.setOnClickListener(ViewStatusAnji.myOnClickListener);
