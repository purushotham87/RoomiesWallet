...
public class MyAdapterByChakri extends RecyclerView.Adapter<MyAdapterByChakri.MyViewHolder> {
    ...
    public MyAdapterByChakri(ArrayList<ByPersonStatus> people) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent,
        ...
        view.setOnClickListener(ViewStatusChakri.myOnClickListener);
