...
public class MyAdapterByKesav extends RecyclerView.Adapter<MyAdapterByKesav.MyViewHolder> {
    ...
    public MyAdapterByKesav(ArrayList<ByPersonStatus> people) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent,
        ...
        view.setOnClickListener(ViewStatusKesav.myOnClickListener);
