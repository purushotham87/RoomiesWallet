 ...
 */
public class ViewStatusSujith extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.view_sujith_status);
        ...
        List<RoomieWallet> cards = db.getAllDetailsByCreditSujith();
        ...
        List<RoomieWallet> cards1 = db.getAllDetailsByDebitSujith();
        for (RoomieWallet roomieWallet : cards1) {

            debit1 = debit1 + Integer.parseInt(roomieWallet.getSujith_amount());
        ...
        Whatsapp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String shareBody = "Hi Sujith,Your Room Bill was : Rs."+status2;
        ...
        adapter = new MyAdapterBySujith(status);
