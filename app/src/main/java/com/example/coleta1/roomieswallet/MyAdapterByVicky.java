...
public class MyAdapterByVicky extends RecyclerView.Adapter<MyAdapterByVicky.MyViewHolder> {
    ...
    public MyAdapterByVicky(ArrayList<ByPersonStatus> people) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent,
        ...
        view.setOnClickListener(ViewStatusVicky.myOnClickListener);
