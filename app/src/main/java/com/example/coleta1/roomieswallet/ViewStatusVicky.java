 ...
 */
public class ViewStatusVicky extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.view_vicky_status);
        ...
        List<RoomieWallet> cards = db.getAllDetailsByCreditVicky();
        ...
        List<RoomieWallet> cards1 = db.getAllDetailsByDebitVicky();
        for (RoomieWallet roomieWallet : cards1) {

            debit1 = debit1 + Integer.parseInt(roomieWallet.getVicky_amount());
        ...
        Whatsapp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String shareBody = "Hi Vicky,Your Room Bill was : Rs."+status2;
        ...
        adapter = new MyAdapterByVicky(status);
