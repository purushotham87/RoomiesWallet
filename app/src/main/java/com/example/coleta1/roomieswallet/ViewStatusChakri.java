 ...
 */
public class ViewStatusChakri extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.view_chakri_status);
        ...
        List<RoomieWallet> cards = db.getAllDetailsByCreditChakri();
        ...
        List<RoomieWallet> cards1 = db.getAllDetailsByDebitChakri();
        for (RoomieWallet roomieWallet : cards1) {

            debit1 = debit1 + Integer.parseInt(roomieWallet.getChakri_amount());
        ...
        Whatsapp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String shareBody = "Hi Chakri,Your Room Bill was : Rs."+status2;
        ...
        adapter = new MyAdapterByChakri(status);
