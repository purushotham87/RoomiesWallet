 ...
 */
public class ViewStatusTrinadh extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.view_trinadh_status);
        ...
        List<RoomieWallet> cards = db.getAllDetailsByCreditTrinadh();
        ...
        List<RoomieWallet> cards1 = db.getAllDetailsByDebitTrinadh();
        for (RoomieWallet roomieWallet : cards1) {

            debit1 = debit1 + Integer.parseInt(roomieWallet.getTrinadh_amount());
        ...
        Whatsapp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String shareBody = "Hi Trinadh,Your Room Bill was : Rs."+status2;
        ...
        adapter = new MyAdapterByTrinadh(status);
